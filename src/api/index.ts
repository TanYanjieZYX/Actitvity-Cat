...
export const getAllEvents = (token: string, offset: number) =>
  fetch('http://localhost:8080/api/v1/events?offset=' + offset, {
    method: 'get',
    mode: 'cors',
    headers: {
      'Content-type': 'application/json; charset=UTF-8',
...
export const getEvents = (token: string, params: string) =>
  fetch('http://localhost:8080/api/v1/events?' + params, {
    method: 'get',
    mode: 'cors',
    headers: {
      'Content-type': 'application/json; charset=UTF-8',
...
export const getParticipants = (token: string, id: number) =>
  fetch('http://localhost:8080/api/v1/events/' + id + '/participants', {
    method: 'get',
    mode: 'cors',
    headers: {
      'Content-type': 'application/json; charset=UTF-8',
...
export const getLikes = (token: string, id: number) =>
  fetch('http://localhost:8080/api/v1/events/' + id + '/likes', {
    method: 'get',
    mode: 'cors',
    headers: {
      'Content-type': 'application/json; charset=UTF-8',
...
export const getComments = (token: string, id: number) =>
  fetch('http://localhost:8080/api/v1/events/' + id + '/comments', {
    method: 'get',
    mode: 'cors',
    headers: {
      'Content-type': 'application/json; charset=UTF-8',
...
export const getEventByType = (token: string, type: string) =>
  fetch('http://localhost:8080/api/v1/user/events?type=' + type, {
    method: 'get',
    mode: 'cors',
    headers: {
      'Content-type': 'application/json; charset=UTF-8',
